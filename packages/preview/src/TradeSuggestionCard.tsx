// /klinecharts-workspace/packages/preview/src/TradeSuggestionCard.tsx

import { Component, createMemo, createEffect, onCleanup, For, createSignal, Show } from 'solid-js';
import { Chart, ActionType } from '@klinecharts/core'; // +++ Import ActionType
...
const TradeSuggestionCard: Component<TradeSuggestionCardProps> = (props) => {
      ...
      takeProfits.forEach((tp, i) => {
        if (tp.price > 0) {
           overlaysToCreate.push({
            ...
            points: [{ value: tp.price }], styles: { line: { color: '#1677FF', style: 'dashed' } },
          });
        }
      });
  ...
  const currentTradeDetails = createMemo(() => {
    ...
    return {
      ...
      quantity: props.suggestion.trade_suggestion.quantity
    };
  });
  ...
  return (
    <>
      <div class="message ai-message">
        <div class="message-content" style={{ "border-color": "var(--chat-primary-color)" }}>
          <div class="trade-suggestion-card">
            ...
            <div class="trade-details">
              ...
              <div class="trade-param">Leverage: <strong><EditableValue value={leverage()} onUpdate={onValueUpdate(setLeverage)} suffix="x" /></strong></div>
